import { html, mount, getCachedProfile, loadUserProfile, updateNavPermissions, updateAvatar, alertModal, confirmModal, formatDate, isAuthenticated, updateRoleBadge, applyPagePermissions } from '../utils.js';
